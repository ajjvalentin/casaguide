...
export const HELP_INDEX = [
  ...
  },
  {
    id: "visible-guide",
    step: 5,
    question: "La bascule « Visible dans le guide »",
    keywords: ["visible dans le guide", "bascule", "interrupteur",
      "masquer une rubrique", "afficher une rubrique", "cocher",
      "case à cocher", "visible", "cacher une rubrique"],
    steps: [
      "« Visible dans le guide » montre ou masque la rubrique aux voyageurs (elle reste modifiable ici).",
      "Une rubrique vide n'apparaît jamais chez le voyageur, même visible : le guide reste propre.",
      "L'avancement, lui, se mesure tout seul sur ce que vous remplissez — voyez « le fil des étapes ».",
    ],
    target: { route: "#/properties/:id/editor", label: "Ouvrir le guide" },
  },
  {
    id: "fil-etapes",
    step: null,
    question: "Le fil des étapes — où en est mon guide ?",
    keywords: ["fil des étapes", "où j'en suis", "étape", "prochaine étape",
      "étape suivante", "progression", "avancement", "indicateur", "tableau de bord",
      "complétude", "étape courante", "que faire maintenant", "que faire ensuite",
      // Les libellés d'action du fil (couverts au mot près — même vocabulaire partout).
      "Renseigner votre logement", "Ajouter les indispensables", "Rechercher les lieux",
      "Valider vos lieux suggérés", "Publier votre guide", "Envoyer le guide",
      "Compléter le reste du guide", "Guide envoyé"],
    steps: [
      "Chaque logement affiche « Étape k/7 · … » : là où vous en êtes, et l'action qui suit.",
      "Le fil se calcule sur ce que vous avez RÉELLEMENT rempli (jamais sur une case à cocher).",
      "Cliquez le fil pour aller droit à la prochaine action ; l'étape 5 (« le reste ») est facultative.",
    ],
    target: { route: "#/properties", label: "Voir mes logements" },
  },
  {
    id: "traductions",
    step: 6,
