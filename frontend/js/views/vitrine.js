...
const S = {
  fr: {
    ...
    how_trav_1: "Indiquez une adresse, un quartier ou un point sur la carte.",
  ...
  en: {
    ...
    how_trav_1: "Enter an address, a neighbourhood or a point on the map.",
  ...
  es: {
    ...
    how_trav_1: "Indica una dirección, un barrio o un punto en el mapa.",
