...
const STRINGS = {
  fr: {
    ...
    offer_desc: "Restaurants, plages, commerces, urgences — le guide complet du secteur de votre lieu de vacances, généré pour l'adresse ou le point de votre choix.",
    offer_cta: "Créer mon guide", offer_have: "J'ai déjà acheté un guide",
    addr_title: "Quel lieu voulez-vous explorer ?",
    addr_intro: "Une adresse, un quartier ou un point sur la carte — le guide couvre ses environs.",
    f_address: "Adresse ou lieu", f_postal: "Code postal", f_city: "Ville / commune",
    ...
    err_locate: "Situez d'abord le lieu sur la carte.",
  ...
  en: {
    ...
    offer_desc: "Restaurants, beaches, shops, emergencies — the complete guide to the area around your holiday spot, generated for the address or point of your choice.",
    offer_cta: "Create my guide", offer_have: "I already bought a guide",
    addr_title: "What place do you want to explore?",
    addr_intro: "An address, a neighbourhood or a point on the map — the guide covers its surroundings.",
    f_address: "Address or place", f_postal: "Postcode", f_city: "Town / city",
    ...
    err_locate: "First locate the place on the map.",
  ...
  es: {
    ...
    offer_desc: "Restaurantes, playas, comercios, emergencias — la guía completa de la zona de tu lugar de vacaciones, generada para la dirección o el punto que elijas.",
    offer_cta: "Crear mi guía", offer_have: "Ya he comprado una guía",
    addr_title: "¿Qué lugar quieres explorar?",
    addr_intro: "Una dirección, un barrio o un punto en el mapa — la guía cubre sus alrededores.",
    f_address: "Dirección o lugar", f_postal: "Código postal", f_city: "Ciudad / municipio",
    ...
    err_locate: "Sitúa primero el lugar en el mapa.",
